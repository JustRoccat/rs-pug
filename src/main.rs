                    ...
                    match key.code {
                        ...
                        KeyCode::Char('v') if app.active_tab == Tab::Local => {
                            app.local_view_mode = match app.local_view_mode {
                                crate::model::LocalViewMode::Flat => crate::model::LocalViewMode::Organized,
                                crate::model::LocalViewMode::Organized => crate::model::LocalViewMode::Flat,
                            };
                            app.set_flash(
                                format!(
                                    "View mode: {}",
                                    match app.local_view_mode {
                                        crate::model::LocalViewMode::Flat => "Flat",
                                        crate::model::LocalViewMode::Organized => "Organized",
                                    }
                                ),
                                2,
                            );
                                            ...
                                            match app.local_nav_level {
                                                crate::model::LocalNavLevel::Artists => {
                                                    ...
                                                    if let Some(artist) = artists.get(app.selected_local_nav_idx) {
                                                        ...
                                                        app.local_nav_level = crate::model::LocalNavLevel::Albums;
                                                ...
                                                crate::model::LocalNavLevel::Albums => {
                                                    ...
                                                    if let Some(album) = albums.get(app.selected_local_nav_idx) {
                                                        ...
                                                        app.local_nav_level = crate::model::LocalNavLevel::Songs;
                                                        app.selected_local_nav_idx = 0;
                                                    }
                                                }
